...
import { X, Plus, Clock, Tag, AlignLeft, Sparkles, Calendar } from 'lucide-react';
import { CategoryType, HabitTask, ScheduleType } from '../types';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          {/* Jadwal Hari Kerja vs Akhir Pekan */}
          <div>
            <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5 flex items-center gap-1.5">
              <Calendar className="w-3.5 h-3.5 text-indigo-500" /> Pengaturan Hari / Jadwal Kegiatan
            </label>
            <div className="grid grid-cols-3 gap-2">
              <button
                type="button"
                id="sched-weekday-btn"
                onClick={() => setScheduleType('weekday')}
                className={`py-2 px-2.5 rounded-xl text-xs font-bold transition flex flex-col items-center gap-0.5 border ${
              ...
              >
                ...
                <span className="text-[10px] opacity-80 font-medium">Hari Kerja / Sekolah</span>
              </button>
              <button
                type="button"
                id="sched-weekend-btn"
              ...
              >
                ...
                <span className="text-[10px] opacity-80 font-medium">Akhir Pekan</span>
              </button>
              <button
                type="button"
                id="sched-all-btn"
              ...
              >
                ...
                <span className="text-[10px] opacity-80 font-medium">Senin - Minggu</span>
              </button>
            </div>
          </div>
